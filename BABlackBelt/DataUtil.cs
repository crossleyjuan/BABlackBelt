...
namespace BABlackBelt
{
    ...
    public class DataUtil
    {
        ...
        public static SqlDbType GetSQLType(DBDataType type)
        {
            int iValue = (int)type;
            return (SqlDbType)iValue;
        }
        ...
        public static Oracle.DataAccess.Client.OracleDbType GetOracleType(DBDataType type)
        {
            OracleDbType result;
            switch (type)
            {
                ...
                case DBDataType.VarChar:
                    result = OracleDbType.Varchar2;
                    break;
                case DBDataType.Variant:
                    result = OracleDbType.Object;
                    break;
                case DBDataType.Xml:
                case DBDataType.Udt:
                case DBDataType.Structured:
                    throw new Exception("Unsupported type: " + type);
                    break;
